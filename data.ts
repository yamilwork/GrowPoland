...
export const translations: Record<Language, CorporateData & { restricted: any }> = {
  es: {
    ...
    exportDivision: {
      ...
      description: "Impulsando la manufactura local hacia el escenario global, estamos consolidando una unidad de negocio estratégica dedicada a la futura exportación de productos premium 100 % de origen polaco. Actualmente nos encontramos en una fase rigurosa de auditoría de proveedores y análisis de productos, orientada a garantizar los más altos estándares de calidad. Nuestra hoja de ruta contempla la apertura de operaciones para conectar el talento polaco con mercados de alta demanda como el Reino Unido, Estados Unidos y Australia.",
    ...
    footer: {
      ...
      links: {
        ...
        careers: "Carreras",
        news: "Sala de Prensa",
        investors: "Relación con Inversores",
        privacy: "Privacidad",
  ...
  en: {
    ...
    about: {
      ...
      description: "Based in Poland, GrowPoland Investment operates as the parent company for a diverse network of e-commerce businesses. We import innovation from the world's leading manufacturing hubs to serve global markets.",
    ...
    brands: [
      {
        id: "morleyn-pet",
        name: "Morleyn",
        description: "Leaders in premium pet accessories. We manage international suppliers for the UK retail market, with expansion planned for US, Australia, Germany, and Poland.",
      ...
      },
      {
        id: "aurelius-apparel",
        name: "Aurelius & Co.",
        description: "Upcoming men's and women's apparel brand. Currently in market validation and visual identity construction phase for the premium segment.",
      ...
      },
      {
        id: "lumina-artis",
        name: "Lumina Artis",
        description: "Exclusive line of artisanal jewelry featuring semi-precious stones, High-purity Gold and Silver. Merging traditional craft with operational efficiency.",
        market: "Coming Soon",
        image: "https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?auto=format&fit=crop&q=80&w=800"
      }
    ],
    exportDivision: {
      ...
      description: "Propelling local manufacturing onto the global stage, we are consolidating a strategic business unit dedicated to the future export of 100% Polish-origin premium products. We are currently in a rigorous phase of supplier auditing and product analysis, aimed at ensuring the highest quality standards. Our roadmap envisions launching operations to connect Polish talent with high-demand markets such as the UK, USA, and Australia.",
    ...
    blog: [
      {
        ...
        excerpt: "An in-depth analysis of the Polish market's growth as a continental logistics hub in the post-digital era.",
        date: "May 15, 2026",
        category: "Insights",
        image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=800"
      },
      {
        ...
        excerpt: "How automation and predictive algorithms are redefining global delivery times for 2026.",
        date: "May 02, 2026",
        category: "Logistics",
        image: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&q=80&w=800"
      }
    ...
    contact: {
      ...
      description: "Interested in our management capabilities or our new export network? Our management team is ready to talk.",
    ...
    restricted: {
      ...
      description: "Please enter your corporate credentials to continue or contact your account manager.",
      back: "Back to Home",
      badge: "Private Zone",
  ...
  pl: {
    hero: {
      ...
      subtitle: "GrowPoland Investment to wiodący holding zarządzający międzynarodowymi ekosystemami E-commerce i ułatwiający globalny handel dzięki wydajności logistycznej i wizji strategicznej.",
    ...
    about: {
      ...
      description: "Z siedzibą en Polsce, GrowPoland Investment działa jako spółka matka dla zróżnicowanej sieci firm e-commerce. Importujemy innowacje z wiodących światowych centrów produkcyjnych, aby służyć rynkom globalnym.",
      mission: "Naszą misją jest optymalizacja globalnego łańcucha dostaw poprzez technologię i eksperckie zarządzanie marką.",
    ...
    brandsSection: {
      ...
      description: "Zarządzamy globalnymi markami, koncentrując się na optymalizacji operacyjnej i satysfakcji klienta końcowego.",
    ...
    brands: [
      {
        id: "morleyn-pet",
        name: "Morleyn",
        description: "Liderzy w akcesoriach premium dla zwierząt. Zarządzamy międzynarodowymi dostawcami dla rynku detalicznego w Wielkiej Brytanii, z ekspansją na USA, Australię, Niemcy i Polskę.",
      ...
      },
      {
        id: "aurelius-apparel",
        name: "Aurelius & Co.",
        description: "Nadchodząca marka odzieży męskiej i damskiej. Obecnie en fazie walidacji rynkowej i budowy tożsamości wizualnej dla segmentu premium.",
      ...
      },
      {
        id: "lumina-artis",
        name: "Lumina Artis",
        description: "Ekskluzywna linia biżuterii rzemieślniczej z kamieni półszlachetnych, wysokiej próby złota i srebra. Łączenie tradycyjnego rzemiosła z efektywnością operacyjną.",
        market: "Wkrótce",
        image: "https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?auto=format&fit=crop&q=80&w=800"
      }
    ],
    exportDivision: {
      ...
      description: "Wprowadzając lokalną producción na scenę globalną, tworzymy strategiczną jednostkę biznesową dedykowaną przyszłemu eksportowi produktów premium o 100% polskim pochodzeniu. Obecnie znajdujemy się w rygorystycznej fazie audytu dostawców i analizy produktów, mającej na celu zagwarantowanie najwyższych standardów jakości. Nasza mapa drogowa przewiduje uruchomienie operacji łączących polskie rzemiosło z rynkami o wysokim popycie, takimi jak Wielka Brytania, USA i Australia.",
    ...
    blog: [
      {
        ...
        excerpt: "Głęboka analiza wzrostu polskiego rynku jako kontynentalnego hubu logistycznego en erze post-cyfrowej.",
        date: "15 maja 2026",
        category: "Wnioski",
        image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=800"
      },
      {
        ...
        excerpt: "Jak automatyzacja i algorytmy predykcyjne redefiniują globalne czasy dostaw w 2026 roku.",
        date: "02 maja 2026",
        category: "Logistyka",
        image: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&q=80&w=800"
      }
    ...
    contact: {
      ...
      description: "Zainteresowany naszymi możliwościami zarządzania lub nową siecią eksportową? Nasz zespół zarządzający jest gotowy do rozmowy.",
    ...
    footer: {
      description: "Liderzy estratégico zarządzaniu e-commerce i ułatwianiu ekspansji międzynarodowej z Warszawy.",
      company: "Firma",
      support: "Wsparcie",
      contact: "Kontakt",
      links: {
        ...
        careers: "Kariera",
        news: "Biuro prasowe",
        investors: "Relacje inwestorskie",
        privacy: "Prywatność",
        terms: "Warunki prawne"
      },
      madeIn: "Wykonano con doskonałością en Polsce",
    ...
    restricted: {
      ...
      subtitle: "Ten obszar jest przeznaczony wyłącznie dla partnerów i akcjonariuszy GrowPoland Investment.",
      description: "Wprowadź swoje dane korporacyjne, aby kontynuować lub skontaktuj się ze swoim opiekunem konta.",
      back: "Powrót do Strony Głównej",
      badge: "Strefa Prywatna",
      error: "Nieprawidłowe dane logowania. Dostęp odrzucony przez Bramę Bezpieczeństwa GrowPoland."
    }
  } as any
};
