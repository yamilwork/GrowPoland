...
const Home: React.FC<HomeProps> = ({ content, onNavigateToArticle, onNavigateToBrand }) => {
  ...
  return (
    <div className="w-full overflow-x-hidden">
              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center space-x-4 group">
                    ...
                    <div>
                      <div className="text-xs uppercase tracking-widest text-slate-500 font-bold mb-1">{content.contact.phoneLabel}</div>
      ...
      {/* Supplier Modal (Formulario de Contacto Proveedores) */}
      {isSupplierModalOpen && (
          ...
          <div className="bg-white rounded-[2.5rem] p-8 md:p-12 max-w-xl w-full shadow-2xl relative animate-in zoom-in duration-300 border border-slate-100">
            ...
            <div className="mb-8">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                Únase a nuestra red de exportación premium. Estamos auditando productores locales para expansión a UK, USA y Australia.
              </p>
            </div>
            ...
            <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); setIsSupplierModalOpen(false); }}>
              ...
              <div className="space-y-1">
                ...
                <textarea rows={3} required className="w-full p-4 bg-slate-50 border border-slate-100 rounded-2xl text-sm focus:outline-none focus:ring-4 focus:ring-red-600/5 focus:border-red-600 transition-all" placeholder="Describa sus productos clave y capacidades de producción..."></textarea>
              </div>
              ...
              <p className="text-[10px] text-center text-slate-400 uppercase tracking-widest">
                Garantizamos confidencialidad en el proceso de auditoría.
              </p>
            </form>
          </div>
        </div>
